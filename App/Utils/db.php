...
class db{
    ...
    /**
     * Prevede parametr $params na pole
     * @param mixed $params 
     */
    private static function sanitizeParamsArray(&$params) {
    ...
    public static function q(string $q, ...$params) : ?int {
        self::sanitizeParamsArray($params);
    ...
    public static function vratOtazniky($arr) {
        return trim(str_repeat(',?', count($arr)), ',').PHP_EOL;
    }
